...
docker build -f Dockerfile \
  -t registry.digitalocean.com/navkant/django-k8s-web:latest 
  -t registry.digitalocean.com/navkant/django-k8s-web:v1 
```

Use `DOCKER_DEFAULT_PLATFORM="linux/amd64"` for building images in amd architecture.

3. Push Container with 2 tags: latest and random

```
docker push registry.digitalocean.com/navkant/django-k8s-web --all-tags
```
